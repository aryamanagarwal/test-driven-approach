    ...
    describe('The menu',function(){
         ...
         */
         ...
         it('menu is hidden initially',function(){
            ...
            expect(document.getElementsByClassName('menu-hidden')).not.toBeNull();
         });
          ...
          */
          it('menu response on click',function(){
             var oldclass = $('body').val('class');        
             $('.menu-icon-link').click();
             var newclass = $('body').val('class');
             $('.menu-icon-link').click();
    ...
    describe('Initial Entries',function(){
         ...
         */
         ...
         it('feed container contains elements',function(done){
            expect($('.feed').has('.entry').length).not.toBeNull();
            done();
         });
    });
